...
//                    }
//                });
                List<ProductInfo> products = initProducts();
                ProductInfo[] arr = products.toArray(new ProductInfo[products.size()]);
                Arrays.sort(arr, Comparator.comparing(ProductInfo::getPrice));
